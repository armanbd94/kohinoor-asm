...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
		...
		<link rel="icon" type="image/png" href="{{ ADMIN_BASE_PATH.'storage/'.LOGO_PATH.config('settings.favicon')}}">
		<link rel="shortcut icon" href="{{  ADMIN_BASE_PATH.'storage/'.LOGO_PATH.config('settings.favicon')}}" />
