        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form id="customer-receive-form" method="post" class="col-md-7">
                        @csrf
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Upazila" name="upazila_id" col="col-md-6" class="selectpicker" onchange="getRouteList(this.value,2)">
                                @if (!$locations->isEmpty())
                                    @foreach ($locations as $upazila)
                                        @if ($upazila->type == 2 && $upazila->parent_id == auth()->user()->district_id)
                            ...
                            <x-form.selectbox labelName="Route" name="route_id" col="col-md-6" class="selectpicker" onchange="getAreaList(this.value,2)"/>
    
                            <x-form.selectbox labelName="Area" name="area_id" col="col-md-6" class="selectpicker" onchange="customer_list(2)"/>
                            ...
                            <div class="form-group col-md-12 pt-5">
                                <button type="button" onclick="window.location.replace('{{ url("customer-receive") }}')" class="btn btn-danger btn-sm mr-3"><i class="fas fa-sync-alt"></i> Reset</button>
