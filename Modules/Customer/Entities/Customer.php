...
class Customer extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['id','id','name', 'shop_name', 'mobile', 'customer_group_id','upazila_id','route_id', 'area_id','status',null,null];
        
        
        $query = self::with('customer_group','upazila','route','area')
    ...
    {
        return self::toBase()->where('district_id',auth()->user()->district_id)->get()->count();
    }
    /******************************************
