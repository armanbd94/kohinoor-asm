            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Received From" name="customer_id" col="col-md-4" class="selectpicker"/>
                        <x-form.selectbox labelName="Received BY" name="salesmen_id" col="col-md-4" class="selectpicker">
                            @if (!$salesmen->isEmpty())
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api.column( 11 ).footer() ).html('= '+number_format(pageTotal) +' ('+ number_format(total) +' Total)');
        }
    });
